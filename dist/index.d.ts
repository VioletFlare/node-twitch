...
export declare class TwitchApi extends EventEmitter {
    ...
    *************************************/
    ...
    getGlobalBadges(): Promise<APIBadgesResponse>;
    getGlobalEmotes(): Promise<APIEmotesResponse>;
    ...
    getChannelEmotes(broadcasterId: string): Promise<APIEmotesResponse>;
    getChannelBadges(broadcasterId: string): Promise<APIBadgesResponse>;
    /*********************************
    ...
    */
    ...
    getIngestServers(): Promise<APIIngestsResponse>;
}
